...
void draw_dda(struct Point p1, struct Point p2) {
...
void draw_circle(struct Point pC, GLfloat radius) {
...
void display(void) {
	// Terminal struct Points for Needle
	struct Point pHour, pMinute, pSecond;
