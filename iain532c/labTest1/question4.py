...
def a_star_food(source, grid, rows, cols, foods, time):
    ...
    while len(nodes) > 0:
        ...
        for movement in movements:
            ...
            next_node_height = abs(grid[next_node[0]][next_node[1]])
...
def main():
    ...
    for _ in range(test_cases):
        ...
        a_star_food(source, grid, rows, cols, foods, time)
