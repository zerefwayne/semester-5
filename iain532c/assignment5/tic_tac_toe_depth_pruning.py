...
def minimax(board, player_turn, depth, _alpha, _beta):
    ...
    if is_maximizing_player(player_turn):
        ...
        for child in children:
            (val, x, y) = minimax(child[0], 'O', depth-1, alpha, beta)
        ...
        for child in children:
            (val, x, y) = minimax(child[0], 'X', depth-1, alpha, beta)
            ...
            if result is not None:
                ...
                if self.turn == 'X':
                    ...
                    while True:
                        ...
                        start = time.time()
                        (_, suggested_x, suggested_y) = minimax(self.board, self.turn, self.depth, math.inf, -math.inf)
                        end = time.time()
